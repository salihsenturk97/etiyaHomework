...
public class DKGKPSPublicSoap
{
    ...
    public DKGKPSPublicSoap(){}

    public DKGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DKGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DKGExtendedSoapSerializationEnvelope envelope= new DKGExtendedSoapSerializationEnvelope(DKGExtendedSoapSerializationEnvelope.VER11);
