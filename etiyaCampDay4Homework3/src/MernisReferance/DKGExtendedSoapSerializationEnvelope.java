...
public class DKGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DKGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DKGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DKGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DKGDateTimeConverter dateTimeConverter = new DKGStandardDateTimeConverter();

    public DKGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DKGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DKGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DKGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DKGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DKGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
